<script>
    function delete_heart(id) {
        if (localStorage.getItem('heart') != null) {
            ...
            document.getElementById("Myheart_" + id).src = "<?php echo e(asset('storage/img/icon/heart.png')); ?>";
            checkEmptyHeart();
        }
    }
    viewed_heart();
        ...
        if (localStorage.getItem('heart') != null) {
            ...
            for (i = 0; i < data.length; i++) {
                ...
                <tr id="row_heart` + id + `"> 
                    ...
                    <td><a href="` + url + `" class="btn btn-secondary"><img width=20 src="<?php echo e(asset('storage/img/icon/cart-shopping-solid.svg')); ?>"
                alt=""></a>
                        <a onclick="delete_heart(` + id + `)" class="btn btn-danger"><img width=20 src="<?php echo e(asset('storage/img/icon/trash-solid.svg')); ?>"
                alt=""></a>
                        </td>
                </tr>
                `);
    ...
    function add_heart(product_id) {
        ...
        if (matches.length) {
            matches[0].imageSrc = "<?php echo e(asset('storage/img/icon/heart.png')); ?>";
            document.getElementById("Myheart_" + id).src = matches[0].imageSrc;
            delete_heart(id);
        } else {
            newItem.imageSrc = "<?php echo e(asset('storage/img/icon/heart-solid.svg')); ?>";
            ...
            $('#row_heart').find('tbody').append(`
                ...
                `</span><del><span class="format-currency">` + formatprice + `</span></del></td>
                    <td><a href="` + newItem.url + `" class="btn btn-secondary"><img width=20 src="<?php echo e(asset('storage/img/icon/cart-shopping-solid.svg')); ?>"
                alt=""></a>
                        <a onclick="delete_heart(` + id + `)" class="btn btn-danger"><img width=20 src="<?php echo e(asset('storage/img/icon/trash-solid.svg')); ?>"
                alt=""></a>
                        </td>
...
<?php /**PATH D:\laragon\laragon\www\ban-quan-ao\resources\views/product/scriptHeart.blade.php ENDPATH**/ ?>