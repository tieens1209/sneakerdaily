...
unset($__errorArgs, $__bag); ?>
                            <div class="form-group">
                                ...
                                <input type="text" name="email" id="email" placeholder="Your Email" value="<?php echo e(old('email')); ?>"/>
                            </div>
...
unset($__errorArgs, $__bag); ?>
                            <div class="form-group">
                                ...
                                <input type="text" name="fullname" id="name" placeholder="Your Name" value="<?php echo e(old('fullname')); ?>"/>
                            </div>
...
unset($__errorArgs, $__bag); ?>
                            <div class="form-group">
                                ...
                                <input type="text" name="address" id="name" placeholder="Your Address" value="<?php echo e(old('address')); ?>"/>
                            </div>
...
unset($__errorArgs, $__bag); ?>
                            <div class="form-group">
                                ...
                                <input type="text" name="phone" id="phone" placeholder="Your Phone" value="<?php echo e(old('phone')); ?>"/>
                            </div>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="signup-image">
                        ...
                        <a href="<?php echo e(route('login')); ?>" class="signup-image-link">I am already member</a>
                    </div>
                </div>
            </div>
        </section>
...
</html><?php /**PATH C:\Users\ndm10\Desktop\WEB4013 - Lap trinh PHP3\Lab\Assignment\PRJ-MFashion\resources\views/auth/register.blade.php ENDPATH**/ ?>