<?php $__env->startSection('title'); ?>
    Chỉnh sửa sản phẩm(<?php echo e($product->name); ?>)
...
<?php $__env->startSection('content'); ?>
    <div class="container-fluid">
        <div class="container-fluid">
            <div class="card">
                <div class="card-body">
                    <h5 class="card-title fw-semibold mb-4">Chỉnh sửa sản phẩm(<?php echo e($product->name); ?>)</h5>
                    <div class="card">
                        <div class="card-body">
                            <form action="<?php echo e(route('product.update', $product->id)); ?>" method="post"
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="name" class="form-control" id="exampleInputEmail1"
                                        aria-describedby="emailHelp" value="<?php echo e($product->name); ?>">
                                ...
                                <div class="row">
                                    <div class="mb-3 col-6">
                                        ...
                                        <input type="text" name="price" class="form-control" id="exampleInputEmail1"
                                            aria-describedby="emailHelp" value="<?php echo e($product->price); ?>">
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="mb-3 col-6">
                                        ...
                                        <input type="text" name="priceSale" class="form-control" id="exampleInputEmail1"
                                            aria-describedby="emailHelp" value="<?php echo e($product->priceSale); ?>">
                                    ...
                                    <div class="mb-3 col-4">
                                        ...
                                        <select name="category" id="" class="form-select">
                                            <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($category->id); ?>" <?php if($product->idCategory == $category->id): echo 'selected'; endif; ?>>
                                    ...
                                    <div class="mb-3 col-4">
                                        ...
                                        <select name="brand" id="" class="form-select">
                                            <?php $__currentLoopData = $brands; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $brand): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($brand->id); ?>" <?php if($product->idBrand == $brand->id): echo 'selected'; endif; ?>>
...
<?php echo $__env->make('layouts.appAdmin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laragon\laragon\www\ban-quan-ao\resources\views/admin/product/edit.blade.php ENDPATH**/ ?>