        ...
        if (localStorage.getItem('compare') != null) {
            ...
            for (i = 0; i < data.length; i++) {
                ...
                <tr id="row_compare` + id + `"> 
                    ...
                    <td class="text-center"><a href="` + url + `" class="btn btn-outline-dark"><img width=20 src="<?php echo e(asset('storage/img/icon/circle-info-solid.svg')); ?>"
                alt=""></a>
                        <a onclick="delete_compare(` + id + `)" class="btn btn-danger"><img width=20 src="<?php echo e(asset('storage/img/icon/trash-solid.svg')); ?>"
                alt=""></a>
                        </td>
        ...
        if (matches.length) {
            ...
            if (old_data.length < 4) {
                ...
                <tr id="row_compare` + id + `"> 
                    ...
                    <td class="text-center"><a href="` + newItem.url + `" class="btn btn-outline-dark"><img width=20 src="<?php echo e(asset('storage/img/icon/circle-info-solid.svg')); ?>"
                alt=""></a>
                        <a onclick="delete_compare(` + id + `)" class="btn btn-danger"><img width=20 src="<?php echo e(asset('storage/img/icon/trash-solid.svg')); ?>"
                alt=""></a>
                        </td>
...
<?php /**PATH D:\laragon\laragon\www\ban-quan-ao\resources\views/product/scriptCompare.blade.php ENDPATH**/ ?>