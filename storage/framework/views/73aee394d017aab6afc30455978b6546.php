                ...
                <div class="card w-100">
                    <div class="card-body p-4">
                        ...
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('addAccount')): ?>
                            <a href="<?php echo e(route('account.create')); ?>"><button type="submit" class="btn btn-success m-1">Tạo tài
                                    khoản</button></a>
                        <?php endif; ?>
                                            ...
                                            <td class="border-bottom-0" style="display: flex;">
                                                <?php if(is_null($account->deleted_at)): ?>
                                                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('updateAccount')): ?>
                                                        <a href="<?php echo e(route('account.edit', $account->id)); ?>"><button
                                                    ...
                                                    <?php endif; ?>
                                                <?php else: ?>
                                                    <a href="<?php echo e(route('admin.account.unblock', $account->id)); ?>"><button
...
<?php echo $__env->make('layouts.appAdmin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laragon\laragon\www\ban-quan-ao\resources\views/admin/account/index.blade.php ENDPATH**/ ?>