        ...
        <div class="row">
            <div class="card w-100">
                <div class="card-body p-4">
                    ...
                    <a href="<?php echo e(route('category.create')); ?>"><button type="submit" class="btn btn-success m-1">Add</button></a>
                    <?php endif; ?>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="border-bottom-0" style="display: flex;">
                                    ...
                                    <a href="<?php echo e(route('category.edit', $category->id)); ?>"><button type="submit" class="btn btn-info m-1">Update</button></a>
                                    <?php endif; ?>
