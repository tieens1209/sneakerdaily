<?php $__env->startSection('title'); ?>
    Chỉnh sửa thương hiệu(<?php echo e($brand->name); ?>)
...
<div class="container-fluid">
    <div class="container-fluid">
        <div class="card">
            <div class="card-body">
                <h5 class="card-title fw-semibold mb-4">Chỉnh sửa thương hiệu(<?php echo e($brand->name); ?>)</h5>
                <div class="card">
                    <div class="card-body">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.appAdmin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laragon\laragon\www\ban-quan-ao\resources\views/admin/brand/edit.blade.php ENDPATH**/ ?>