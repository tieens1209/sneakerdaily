            ...
            <div class="container">
                <div class="signin-content">
                    ...
                    <div class="signin-form">
                        <h2 class="form-title m-0 pb-3">Change password</h2>
                        <?php if($message = Session::get('success')): ?>
                        <h5 class="text-success pb-4"><?php echo e($message); ?></h5>
                        <?php endif; ?>
                        <form method="POST" action="<?php echo e(route('changePassword', $id)); ?>" class="register-form" id="login-form">
                            <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
                            <div class="form-group">
                                <label for="your_pass"><i class="zmdi zmdi-lock"></i></label>
                                <input type="password" name="repeat_password" id="your_pass" placeholder="Repeat Password"/>
                            </div>
...
</html><?php /**PATH C:\Users\ndm10\Desktop\WEB4013 - Lap trinh PHP3\Lab\Assignment\PRJ-MFashion\resources\views/auth/newPassword.blade.php ENDPATH**/ ?>