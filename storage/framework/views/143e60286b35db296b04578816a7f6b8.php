        ...
        <div class="row">
            <div class="card w-100">
                <div class="card-body p-4">
                    <h5 class="card-title fw-semibold mb-4 mt-5">Brand</h5>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="border-bottom-0" style="display: flex;">
                                    ...
                                    <a href="<?php echo e(route('brand.edit', $brand->id)); ?>"><button type="submit" class="btn btn-info m-1">Update</button></a>
                                    <?php endif; ?>
                                    ...
                                    <?php else: ?>
                                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('deleteBrand')): ?>
                                    <a href="<?php echo e(route('admin.brand.restore', $brand->id)); ?>"><button type="submit" class="btn btn-primary m-1">Restore</button></a>
                                    <?php endif; ?>
                                    <?php endif; ?>
                                </td>
                            </tr> 
