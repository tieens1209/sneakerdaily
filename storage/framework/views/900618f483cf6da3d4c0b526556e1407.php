            ...
            <div class="container">
                <div class="signin-content">
                    ...
                    <div class="signin-form">
                        <h2 class="form-title m-0 pb-3">Welcome back</h2>
                        ...
                        <form method="POST" action="<?php echo e(route('login')); ?>" class="register-form" id="login-form">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="username" id="your_name" placeholder="Your Name" value="<?php echo e(old('username')); ?>"/>
                            </div>
...
unset($__errorArgs, $__bag); ?>
                            <div class="form-group" style="display:flex; justify-content: space-between;">
                                ...
                                <a href="<?php echo e(route('forgotPassword')); ?>" class="signup-image-link">Forgot password</a>
                            </div>
...
</html><?php /**PATH C:\Users\ndm10\Desktop\WEB4013 - Lap trinh PHP3\Lab\Assignment\PRJ-MFashion\resources\views/auth/login.blade.php ENDPATH**/ ?>