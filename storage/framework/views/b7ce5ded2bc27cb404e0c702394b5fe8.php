                    ...
                    <div class="table-responsive">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="border-bottom-0">
                                    <p class="mb-0 fw-normal">X, L, XL</p>
                                </td>
                                <td class="border-bottom-0">
                                    <p class="mb-0 fw-normal">$23 <del>$20</del></p>
                                </td>
                                <td class="border-bottom-0">
                                    <p class="mb-0 fw-normal">Áo nam</p>
                                </td>
                                <td class="border-bottom-0">
                                    <p class="mb-0 fw-normal">Adidas</p>
                                </td>
